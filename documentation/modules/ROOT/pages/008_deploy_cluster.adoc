...
The cluster creation will take around 15 minutes so please grab refreshments and watch the output as shown below. It is also worth watching this output in the web user interface as there is a lot of useful information on the progress of the different components.
...
[IMPORTANT]
====
Come back to this section later if you want to apply any governance policies to the cluster.
====
